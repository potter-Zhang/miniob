...
public:
  ...
  virtual RC modify_record(Table *table, Record &record, const char *field_name, Value new_value) { return RC::SUCCESS; }
  virtual RC insert_index(Table *table, Record &record) {return RC::SUCCESS;}
  virtual RC delete_index(Table *table, Record &record) {return RC::SUCCESS;}
