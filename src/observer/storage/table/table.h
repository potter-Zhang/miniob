...
public:
  ...
  RC modify_record(Record &record, const char *field_name, Value new_value);
  ...
  RC create_unique_index(Trx *trx, std::vector<const FieldMeta *> &field_metas, const char *index_name);
